...
set_property PACKAGE_PIN U2 [get_ports {Analog_select[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Analog_select[0]}]
set_property PACKAGE_PIN U4 [get_ports {Analog_select[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Analog_select[1]}]
set_property PACKAGE_PIN V4 [get_ports {Analog_select[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Analog_select[2]}]
set_property PACKAGE_PIN W4 [get_ports {Analog_select[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Analog_select[3]}]
